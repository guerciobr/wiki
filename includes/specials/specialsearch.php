...
class SpecialSearch extends SpecialPage {
	...
	protected function showCreateLink( $t ) {
		...
		if( $messageName ) {
			//$this->getOutput()->wrapWikiMsg( "<p class=\"mw-search-createlink\">\n$1</p>", $params); Gustavo Guercio - Comentado para nao aparecer o link de criar pagina sem usar o formulario incidentes
			$wgOut->addHtml( '<p><b>Caso nao tenha encontrado algum registro relacionado com sua pesquisa, favor criar um <a href="/wiki/index.php/Form:Incidente" class="new" title="novo registro">Novo registro</a></b></p>' );
			//Gustavo Guercio - Acrescido a linha de cima para mostrar um link para criar pagina usando o formulario incidentes.
		} else {
			// preserve the paragraph for margins etc...
			$wgOut->addHtml( '<p></p>' );
		}
